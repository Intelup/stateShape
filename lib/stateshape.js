...
var array = {
   ...
   */
  objectsArrayMerge: function objectsArrayMerge(array) {
    return this.flattenizeArray(array.map(function (item) {
   ...
   * @returns {Object} Returns the object.
   */
  objectsArrayShape: function objectsArrayShape(name, array) {
    var _this = this;
    ...
    var result = {};
    var firstKey = 'by' + propertyName.replace(/^\w/, function (c) {
      return c.toUpperCase();
    });
    var secondKey = 'all' + (0, _pluralize.default)(propertyName.replace(/^\w/, function (c) {
      return c.toUpperCase();
    }));
    result[name] = {};
    result[name][firstKey] = Object.values(array).reduce(function (obj, row) {
    ...
    if (anotherParameters.length > 0) {
      var anotherObjects = this.flattenizeArray(anotherParameters.map(function (parameter) {
        ...
        var objects = _this.objectsArrayShape(parameter, objectsArray, propertyName);

        return objects;
      }));
      var objectsMerge = this.objectsArrayMerge(anotherObjects);
...
var object = {
   ...
   * @returns {Object} Returns the new object, by removing the object from the key passed by value parameter.
   */
  removeByKey: function removeByKey(objs, value) {
    var keyName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'uuid';
    return Object.values(Object.values(objs).filter(function (obj) {
